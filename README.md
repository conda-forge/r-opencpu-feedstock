About r-opencpu-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-opencpu-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/opencpu/opencpu
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2383&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-opencpu-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-opencpu` can be installed with `conda`:
...
```
mamba install r-opencpu
```

It is possible to list all of the versions of `r-opencpu` available on your platform with `conda`:
...
```
mamba search r-opencpu --channel conda-forge
```
...
mamba repoquery search r-opencpu --channel conda-forge

# List packages depending on `r-opencpu`:
mamba repoquery whoneeds r-opencpu --channel conda-forge

# List dependencies of `r-opencpu`:
mamba repoquery depends r-opencpu --channel conda-forge
```
